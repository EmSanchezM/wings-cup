# Design-System Spec — design-system-and-ui (Slice 8)
...
| Req | Title | Scenarios |
|-----|-------|-----------|
| R-DS-01 | Complete shadcn Semantic Token Set | 3 |
| R-DS-02 | Estadio Nocturno Dark Theme Applied App-Wide | 3 |
| R-DS-03 | shadcn Components Resolve Token Colors | 2 |
| R-DS-04 | Status Color Mapping via Badge | 3 |
| R-DS-05 | Country Flags via TeamFlag | 4 |
