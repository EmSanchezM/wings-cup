# Leaderboard Spec — Delta for realtime-match-and-leaderboard (Slice 6)

## Overview
Delta. One existing requirement extended: R-LEAD-04 gains a realtime scenario — live reorder of standings when `room_members.total_points` changes. R-LEAD-01, R-LEAD-02, R-LEAD-03 are unchanged.

## Requirements Summary

| Req | Title | Type | Scenarios |
|-----|-------|------|-----------:|
| R-LEAD-04 | Leaderboard Page Realtime Reorder | MODIFIED | 4 |
...
**Type**: MODIFIED | **Source**: C3 + Proposal §3.6 / decisions 1, 7
**Files**: `app/pages/rooms/[id]/leaderboard.vue`

(Previously: R-LEAD-04 covered page navigation link from `rooms/[id]/index.vue` and unauthenticated redirect. Extended in slice 4 with auth delegation to `redirectOptions`. Now extended with realtime reorder requirement: page MUST subscribe to `room_members` UPDATEs and reorder within 2 seconds without page refresh.)
...
#### Scenario: Realtime reorder on points change
